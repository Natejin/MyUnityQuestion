...
private:
	...
	bool isTrans;			//배경색 날릴꺼냐?
	COLORREF transColor;		//배경색 날릴 RGB
...
public:
	...
	//비트맵 초기화
	bool LoadSprite(HINSTANCE hInst, HDC hdc,
...
//	//렌더
	...
	void Render(HDC hdc, const int destX, const int destY, const int sourX, const int sourY);
