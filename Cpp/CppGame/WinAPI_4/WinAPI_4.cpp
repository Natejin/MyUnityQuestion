...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    static SquareObject* anotherObject = nullptr;
    ...
    case WM_CREATE:
        ...
        anotherObject = new SquareObject(500, 500, 100, 100);
        }
        break;
    case WM_COMMAND:
        {
    ...
    case WM_PAINT:
        {
           ...
           hdc = BeginPaint(hWnd, &ps);
            ...
            anotherObject->RectangleMakeCenter(hdc);
    ...
    case WM_KEYDOWN:
        {
            ...
            {
                pos.SetPos(0, -speed);
                if (player->CheckCollision(temp, anotherObject, pos))
                {
                    //corrision = true;
                }
                else {
                ...
                /*if (IntersectRect(&temp, player->outsideRect->rect, anotherObject->outsideRect->rect))
                {
                    corrision = true;
                }
                else {
