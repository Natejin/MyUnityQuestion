...
void airHockey::render(HDC hdc)
{
	...
	wsprintf(score1, TEXT("1P 점수 : %d", score[0]));
	TextOut(hdc, 20, WINSIZEY - 40, score1, lstrlen(score1));
	wsprintf(score2, TEXT("2P 점수 : %d", score[1]));
	TextOut(hdc, 20,20, score2, lstrlen(score2));
}
