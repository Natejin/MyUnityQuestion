...
Image * ImageManager::AddImage(string strKey, const char * fileName, double x, double y, int width, int height, bool isTrans, COLORREF transColor)
{
...
Image * ImageManager::AddImage(string strKey, const char * fileName, double x, double y, int width, int height, int frameX, int frameY, bool isTrans, COLORREF transColor)
{
